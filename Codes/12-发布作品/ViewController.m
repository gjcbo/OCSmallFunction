...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.imageView.image = renderedImg;
...
- (void)initialization {
    ...
    //默认值是
    self.selectedImg = thumbnailImage; //默认是第一个
...
- (IBAction)saveAction:(id)sender {
    ...
    UIImageWriteToSavedPhotosAlbum(self.selectedImg, self, @selector(image:didFinishSavingWithError:contextInfo:),  (__bridge void *)self);
}
